...
" =============
"
" This colorscheme has been modified by me (Benjamin Bockhöfer [benjamin.bockhofer@web.de]
" to match my i3-gaps colorscheme. It is based on rakr-light. Details below
"
" rakr-light from:
"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  let boring      = "ffffff"
  let darkGrey    = "111111"
  let neonGreen   = "87ff00"
  let termBlue    = "1e90ff"
  let lighterGrey = "222222"
  ...
  hi ColorColumn guibg=#131313

  " Default Colors
  call <SID>X("Normal",                     lightclouds,      bg2,      "none")
  call <SID>X("Folded",                     fg0,      lighterGrey,      "none")
  ...
  call <SID>X("MatchParen",                 neonGreen, darkGrey,      "bold,underline")
  call <SID>X("NonText",                    darkGrey,      bg1,       "")
  ...
  call <SID>X("LineNr",                     fg0,      bg1,      "")
  call <SID>X("PMenu",                      termBlue,      darkGrey,      "none")
  call <SID>X("PMenuSel",                   termBlue,      lighterGrey,      "none")
  call <SID>X("PMenuThumb",                 termBlue,      lighterGrey,      "none")
  call <SID>X("PMenuSbar",                  termBlue,      lighterGrey,      "none")
  call <SID>X("Todo",                       accent22, accent00, "bold")
  call <SID>X("VertSplit",                  darkGrey,      fg0,      "")
  call <SID>X("Visual",                     darkGrey,      belizeHole, "")
  call <SID>X("VisualNOS",                  darkGrey,      belizeHole,      "")
  call <SID>X("StatusLine",                 wetAsphalt,      belizeHole,      "")
  ...
  " NERDTREE highlights
  call <SID>X("Directory",                  belizeHole,      "",       "bold")
  call <SID>X("NERDTreeCWD",                fg2,      "",       "bold")
  call <SID>X("NERDTreeFlags",              boring,      "",       "bold")
  call <SID>X("NERDTreeFile",               boring,      "",       "")
  call <SID>X("NERDTreeDirSlash",           neonGreen,      "",       "")
  call <SID>X("NERDTreeExecFile",           neonGreen,      "",       "")
