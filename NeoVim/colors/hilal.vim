...
" Editor settings
hi Normal          guifg=#dadada    guibg=NONE       gui=NONE
hi Cursor          guifg=#171717    guibg=#dadada    gui=NONE
hi CursorLine      guifg=#87ff00    guibg=#1e1e1e    gui=NONE
hi LineNr          guifg=#6f6f6f    guibg=#1e1e1e    gui=NONE
hi CursorLineNR    guifg=#1066dd    guibg=#1e1e1e    gui=BOLD
...
hi Visual          guifg=#ffffff    guibg=#1066dd    gui=NONE
hi VisualNOS       guifg=NONE       guibg=#1066dd    gui=NONE
...
hi Identifier      guifg=#1066dd    guibg=NONE       gui=NONE
...
hi Special         guifg=#000aff    guibg=NONE       gui=NONE
